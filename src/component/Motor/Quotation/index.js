...
class Quotation extends React.Component{ 
  ...
  setData = () => {
    ...
    if(this.state.insuranceType === "Comprehensive"){
      sessionStorage.setItem("plan_type", "Basic + Driver + Family (PAB)")
    }
    else if(this.state.insuranceType === "TPL"){
      sessionStorage.setItem("plan_type", "Basic + Driver")
    }
  }
  removeData = () => {
  ...
  componentDidMount(){
    ...
    const backUrl = policyType === "renewal" ? "/existing-policy-details" : "/quotation-details";
    const estimatedValue = (sessionStorage.getItem("estimate_value")) ? parseFloat(sessionStorage.getItem("estimate_value")) : 50000;
    const insuranceType = sessionStorage.getItem("insurance_type") ? sessionStorage.getItem("insurance_type") : "TPL";
    let BasePrice = "";
    ...
    this.setState({ BasePrice, insuranceType, backUrl, estimatedValue})
  }

  render(){
    return(
      <div className="row min-vh-100 align-items-md-center justify-content-md-center ">
        <div className="gradient-bg w-100 pc body-pb position-relative">
          ...
          <Link to={this.state.backUrl} onClick={this.removeData}>
            ...
            <div className="d-flex align-items-center justify-content-between">
              ...
              <img src={QuotationImg} alt="Qoutation Details" />
            </div>
          </div>
          <div className="d-flex justify-content-between align-items-center top-input-label ">
            <div className="quotation-top-heading">Quotations for you</div>
            <div className="Province-container d-flex align-items-center">
              Province : &nbsp;
              <select className="province-select">
                ...
                <option value="DHAKHLIYA & DHAHIRA" > DHAKHLIYA & DHAHIRA </option>
              </select>
            </div>
          </div>
          {
